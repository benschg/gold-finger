...
import type { RecurringIncomeWithCategory } from "@/types/database";
import { getCurrencySymbol } from "@/lib/constants";
import { formatRecurrenceRule } from "@/lib/recurrence";

interface RecurringIncomeTableProps {
  recurringIncomes: RecurringIncomeWithCategory[];
  onEdit?: (recurringIncome: RecurringIncomeWithCategory) => void;
  onDelete?: (recurringIncome: RecurringIncomeWithCategory) => void;
  onTogglePause?: (recurringIncome: RecurringIncomeWithCategory) => void;
}
...
export function RecurringIncomeTable({
  ...
  const columns: ColumnDef<RecurringIncomeWithCategory>[] = useMemo(
    () => [
      {
        accessorKey: "summary",
        header: t("summary"),
